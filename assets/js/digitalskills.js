const skillGroups = [
    {
      ...
      skills: [
        ...
        },
        {
          ...
          description:
            "A powerful internationalization framework for translating applications effortlessly.",
        },
        {
          name: "ThreeJS",
      ...
      skills: [
        {
          ...
          description:
            "A widely-used server-side scripting language designed for web development. It powers dynamic websites and applications with seamless backend logic.",
        },
       {
            name: "Apache",
            logo: "https://images.seeklogo.com/logo-png/31/2/apache-logo-png_seeklogo-314278.png",
            description: "A widely used open-source web server software for hosting dynamic and static websites, offering robust security and performance."
        },
        
        {
          ...
          description:
            "A modern PHP framework known for its elegant syntax and powerful features. It simplifies web application development with built-in tools and robust security.",
        },
        {
          name: "MySQL(MariaDB)",
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          ...
          description:
            "A modern framework that connects Laravel and React, Vue, or Svelte seamlessly. It allows for full-stack development without needing a traditional API.",
        },
        {
          name: "PHPStorm",
          logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/PhpStorm_Icon.svg/2048px-PhpStorm_Icon.svg.png",
          description:
            "A powerful IDE for PHP development, providing advanced code editing, debugging, and testing features for professional developers working with PHP and web technologies.",
        },
...
skillGroups.forEach((e) => {
  const o = document.createElement("div");
  o.classList.add("skill-group");
  const t = document.createElement("h3");
  (t.innerText = e.groupName), t.classList.add("group-title");
  const i = document.createElement("div");
  i.classList.add("skills-list"),
    e.skills.forEach((e) => {
      const o = document.createElement("div");
      o.classList.add("skill-card");
      const t = document.createElement("img");
      (t.src = e.logo),
        (t.alt = e.name + " logo"),
        (t.loading = "lazy"),
        (t.title = e.name + " logo"),
        t.classList.add("skill-logo");
      const n = document.createElement("div");
      n.classList.add("skill-name"), (n.innerText = e.name);
