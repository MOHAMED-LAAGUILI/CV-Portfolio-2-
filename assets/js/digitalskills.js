    ...
    skills: [
      {
        ...
        description:
          "The foundational technologies for web development: HTML for structure, CSS for styling, and JavaScript for functionality.",
      },
      {
        name: "MERN",
        logo: "https://www.tridentspark.com/wp-content/uploads/2023/07/mern-stack-icon-1.png",
        description:
          "A full-stack JavaScript framework that uses MongoDB, Express.js, React, and Node.js to build modern web applications.",
      },
      {
        name: "PERN",
        logo: "https://repository-images.githubusercontent.com/141744474/1ce68080-769e-11ea-8f62-d743905db95e",
        description:
          "A full-stack web development framework using PostgreSQL, Express.js, React, and Node.js to build scalable applications.",
      },
    ],
  },
  {
